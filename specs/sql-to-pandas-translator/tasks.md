...
- [x] 3. Implement the Input Validator
  ...
  - [x] 3.2 Write property test for Input Validator
...
- [x] 4. Implement the SQL Parser
  ...
  - [x] 4.2 Write unit tests for SQL Parser
...
- [x] 6. Implement the Explanation Generator
...
- [x] 7. Implement the Error Handler
  ...
  - [x] 7.2 Write unit tests for Error Handler
